$(document).ready(function() {
		...
		var oTable = $('#tableResidence').DataTable({
		...
		$("#tableResidence thead th input[type=text]").on( 'keyup change', function () {
		...
		$("#tableResidence thead th .filterSelect").on( 'change', function () {
