$(document).ready(function() {
		...
		var oTable = $('#tablePersonal').DataTable({
		...
		$("#tablePersonal thead th input[type=text]").on( 'keyup change', function () {
		...
		$("#tablePersonal thead th .filterSelect").on( 'change', function () {
